...
import { EditStudentData } from "../Redux/Actions";
...
const EditPage = ({navigation,route}) => {
    ...
    const CheckAttheProceedButton = () =>{
        ...
        if(FormData.email.match(mailformat) && FormData.firstname.length > 2 && FormData.lastname.length > 2 && FormData.address.length > 10 && FormData.nationality.length > 4  ){
            ...
            // dispatch(EditStudentData(FormData.firstname,FormData.lastname,FormData.address,FormData.email,FormData.nationality,FormData.phone,FormData.dob,propData.id))
            dispatch(EditStudentData(FormData,Data.id))
        ...
        <View style={styles.Container}>
            <View style={styles.Top}>
                ...
                <View style={{ height: "100%", width: "100%", justifyContent: "center", alignItems: "center" }}>
                    <Text style={{ fontSize: 27, fontWeight: "bold", color: AllColors.Color.orange }} >Edit Your <Text style={{ fontSize: 27, fontWeight: "bold", color: AllColors.Color.blue }}>Data</Text></Text>
                </View>
            </View>
            ...
            <KeyboardAwareScrollView contentContainerStyle={styles.Middle} >
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.firstname}
                            fontSize={16}
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.lastname}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.email}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.address}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.nationality}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.dob}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                            value={FormData.dob}
                            onChangeText={(txt) => { 
                ...
                <View style={{ height: 85, width: "85%", flexDirection: "column", marginBottom: 10 }}>
                    ...
                    <View style={{ height: 50, width: "100%", justifyContent: "center" }}>
                        <TextInput
                            placeholder={Data.StudentData.phone}
                            fontSize={16}
                            style={{ padding: 0, paddingLeft: 5, borderColor: "lightgrey", borderWidth: 1, height: "80%" }}
                ...
                <View style={styles.ButtomOuterView}>
                    ...
                    >
                        <Text style={styles.NAmeText} >Update</Text>
                        <Icon
